...
def process_and_plot_to_array(nc_file):
    ...
    if lats is not None and lons is not None:
        # Narrower Japan region coordinates (focused area)
...
def extract_data_and_clusters(nc_files):
    ...
    print(f"Geographic region: Japan Narrowed (32.44353°N-36.96479°N, 126.55888°E-132.165°E)")
...
if __name__ == "__main__":
    ...
    # Save model
    torch.save(model.state_dict(), 'models/sa_convlstm_japan_microplastics.pth')
    ...
    results = {
        ...
        'geographic_region': {
            'name': 'Japan',
            'southwest': [32.44353, 126.55888],
            'northeast': [36.96479, 132.165],
            'description': 'SA-ConvLSTM model with self-attention for narrowed Japan region microplastics prediction'
        }
    }
    ...
    print("- models/sa_convlstm_japan_microplastics.pth")
    print("=" * 60)
    ...
    # Save forecast model
    torch.save(forecast_model.state_dict(), 'models/sa_convlstm_forecast_model.pth')
    ...
    print("- models/sa_convlstm_forecast_model.pth")
    print("=" * 60)

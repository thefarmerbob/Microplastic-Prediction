...
from training_scripts.sa_convlstm_microplastics_narrow import extract_data_and_clusters, create_sequences_from_data
...
def create_test_data_for_validation(nc_files, num_tests=20):
    ...
    from training_scripts.sa_convlstm_microplastics_narrow import temporal_train_test_split_proper, create_sequences_from_data
